  ...
  <body>
    ...
    <div class="container">
	    <form class="form-horizontal" id="writeForm" method="post" action="/company/companyWriteAction.wilco">
	      <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
	      <input type="hidden" class="form-control" id="cpMngId" name="cpMngId" placeholder="관리번호" value="${companyManageDetail.cpMngId}">
		  <div class="form-group">
		    <label for="inputEmail3" class="col-sm-2 control-label">관리번호</label>
		    <div class="col-sm-10">
		      <p class="form-control-static">WILCO-${companyManageDetail.cpMngId}</p>
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputPassword3" class="col-sm-2 control-label">발주처명</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="cpName" name="cpName" placeholder="발주처명" value="${companyManageDetail.cpName}">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputEmail3" class="col-sm-2 control-label">담당자명</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="cpWorkNm" name="cpWorkNm"  placeholder="담당자명" value="${companyManageDetail.cpWorkNm}">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputPassword3" class="col-sm-2 control-label">담당자사무실번호</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="cpWorkOffice" name="cpWorkOffice" placeholder="담당자사무실번호" value="${companyManageDetail.cpWorkOffice}">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputPassword3" class="col-sm-2 control-label">담당자팩스번호</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="cpWorkFax" name="cpWorkFax" placeholder="담당자팩스번호" value="${companyManageDetail.cpWorkFax}">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputPassword3" class="col-sm-2 control-label">담당자휴대폰번호</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="cpWorkMobile" name="cpWorkMobile" placeholder="담당자휴대폰번호" value="${companyManageDetail.cpWorkMobile}">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="inputPassword3" class="col-sm-2 control-label">담당자이메일</label>
		    <div class="col-sm-10">
		      <input type="email" class="form-control" id="cpWorkEmail" name="cpWorkEmail" placeholder="담당자이메일" value="${companyManageDetail.cpWorkEmail}">
		    </div>
		  </div>
		  <div class="form-group">
