...
<html>
  ...
  <body>
    ...
    <div class="container">
    	...
    	<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
    	<input type="hidden" id="cpMngId" name="cpMngId" value="" />
            ...
            <th>삭제여부</th>
	          ...
	          <c:forEach items="${pagingList}" var="companyList" varStatus="cpIdx">
	              <tr onclick="javascript:goDetail('${companyList.cpMngId}')">
		            ...
		            <td><c:out value="${companyList.cpWorkNm}"/></td>
    ...
    var manageForm = $("#manageForm");	
    	$(function(){
	    	...
	    	$("#write").click(function(){
	    		manageForm.prop("action" , "/company/companyManageWrite.wilco").submit();
	    	});	
	    	
	    	$("#delete").click(function(){
	    		manageForm.prop("action" , "/company/companyDeleteAction.wilco").submit();
	    	});
    	...
    	var goDetail = function(cpMngId){
    		$("#cpMngId").val(cpMngId);
    		manageForm.prop("action" , "/company/companyManageDetail.wilco").submit();
    	}
